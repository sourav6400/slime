...
@section('title') {{ 'All Socials' }} @endsection
                ...
                <div class="col-sm-12 col-lg-8">
                    <div class="dt-action-buttons d-flex align-items-center justify-content-lg-end justify-content-center flex-md-nowrap flex-wrap">
                        ...
                        <div class="dt-buttons btn-group flex-wrap">
                            <button class="btn add-new btn-primary mt-50" tabindex="0" aria-controls="DataTables_Table_0" type="button" data-bs-toggle="modal" data-bs-target="#addPermissionModal"><span>Add Social</span></button>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <a class="dropdown-item edit-social" data-bs-toggle="modal" data-bs-target="#editPermissionModal" data-social_id="{{ $social->id }}"  data-social="{{ $social->social }}" >
                                                <i data-feather="edit-2" class="me-50"></i>
                                                <span>Edit</span>
                                            </a>
                                            <!--<a class="dropdown-item delete-social" data-bs-toggle="modal" data-bs-target="#deletePermissionModal" data-social_id="{{ $social->id }}">-->
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body px-sm-5 pb-5">
                        <div class="text-center mb-2">
                            <h1 class="mb-1">Add New Social</h1>
                        </div>
                        <form id="addPermissionForm" class="row" onsubmit="return true" novalidate="novalidate" action="{{ route('add_social') }}" method="POST">
                            @csrf
                            <div class="col-12 mb-1">
                                <label class="form-label" for="modalPermissionName">Social Name</label>
                                <input type="text" id="modalPermissionName" name="social_name" class="form-control" placeholder="Social Name" autofocus="" data-msg="Please enter permission name">
                            </div>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body p-3 pt-0">
                        ...
                        <form id="editPermissionForm" class="row" onsubmit="return true" novalidate="novalidate" action="{{ route('edit_social') }}" method="POST">
                            @csrf
                            <input type="hidden" name="social_id" id="social_id" value="" />
                            <div class="col-sm-9">
                                <label class="form-label" for="editPermissionName">Social Name</label>
                                <input type="text" id="social_name" name="social_name" class="form-control" placeholder="Enter a Social name" tabindex="-1" data-msg="Please enter permission name">
                            </div>
        ...
        <div class="modal fade" id="deletePermissionModal" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body p-3 pt-0">
                        <div class="text-center mb-2">
                            <h1 class="mb-1">Delete Social</h1>
                        </div>

                        <div class="alert alert-warning" role="alert">
                            <h6 class="alert-heading">Warning!</h6>
                            <div class="alert-body">
                                Are you sure to delete this social?
                            </div>
                        </div>

                        <form id="deletePermissionModal" class="row" onsubmit="return true" novalidate="novalidate" action="{{ route('delete_social') }}" method="POST">
                            @csrf
                            <input type="hidden" id="social_id_to_delete" name="social_id_to_delete" value="" />
...
<script>
    $(document).on("click", ".edit-social", function () {
        var socialId = $(this).data('social_id');
        var socialName = $(this).data('social');
        
        $("#social_id").val( socialId );
        $("#social_name").val( socialName );
    });
    
    $(document).on("click", ".delete-social", function () {
        var socialId = $(this).data('social_id');
        
        $("#social_id_to_delete").val( socialId );
    });
</script>
@endsection