                ...
                <div class="col-sm-12 col-lg-8">
                    <div class="dt-action-buttons d-flex align-items-center justify-content-lg-end justify-content-center flex-md-nowrap flex-wrap">
                        ...
                        <div class="dt-buttons btn-group flex-wrap">
                            <button class="btn add-new btn-primary mt-50" tabindex="0" aria-controls="DataTables_Table_0" type="button" data-bs-toggle="modal" data-bs-target="#addPermissionModal"><span>Add Tag</span></button>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <a class="dropdown-item edit-tag" data-bs-toggle="modal" data-bs-target="#editPermissionModal" data-tag_id="{{ $tag->id }}"  data-tag="{{ $tag->tag }}">
                                                <i data-feather="edit-2" class="me-50"></i>
                                                <span>Edit</span>
                                            </a>
                                            <a class="dropdown-item delete-tag" data-bs-toggle="modal" data-bs-target="#deletePermissionModal" data-tag_id="{{ $tag->id }}">
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body px-sm-5 pb-5">
                        ...
                        <form id="addPermissionForm" class="row" onsubmit="return true" novalidate="novalidate" method="POST" action="{{ route('add_tag') }}">
                            @csrf
                            <div class="col-12 mb-1">
                                <label class="form-label" for="modalPermissionName">Tag Name</label>
                                <input type="text" id="modalPermissionName" name="tag_name" class="form-control" placeholder="Tag Name" autofocus="" data-msg="Please enter permission name" required>
                            </div>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body p-3 pt-0">
                        ...
                        <form id="editPermissionForm" class="row" onsubmit="return true" novalidate="novalidate" action="{{ route('edit_tag') }}" method="POST">
                            @csrf
                            <div class="col-sm-12 modal-input">
                                <input type="hidden" id="tag_id" name="tag_id" value="" />
                                <label class="form-label" for="editPermissionName">Tag Name</label>
                                <input type="text" id="editPermissionName" name="tag_name" class="form-control" value="" placeholder="Enter a Tag name" tabindex="-1" data-msg="Please enter permission name">
                            </div>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body p-3 pt-0">
                        ...
                        <form id="deletePermissionModal" class="row" onsubmit="return true" novalidate="novalidate" action="{{ route('delete_tag') }}" method="POST">
                            @csrf
                            <input type="hidden" id="tag_id_to_delete" name="tag_id_to_delete" value="" />
...
<script>
    $(document).on("click", ".edit-tag", function () {
        ...
        $("#tag_id").val( tagId );
        $("#editPermissionName").val( tagName );
    });
    $(document).on("click", ".delete-tag", function () {
        var tagId = $(this).data('tag_id');
        
        $("#tag_id_to_delete").val( tagId );
    });
</script>
@endsection
