                            ...
                            <table class="dt-advanced-search table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr class="all-influencer-row" id="all-influencer-row-{{ $influencer->id }}">
                                        ...
                                        // Youtube API
                                        $youtube_detail = DB::table('influencer_socials')
                                            ->where('influencer_id', $influencer_id)
                                            ->where('social_id', $youtubeId)
                                            ->first();
                                        
                                        $youtube_followers_count = null;
                                        
                                        if($youtube_detail)
                                        {
                                            $url = $youtube_detail->social_address;
                                            ...
                                            curl_setopt_array($curl, array(
                                              CURLOPT_URL => 'https://www.googleapis.com/youtube/v3/channels?part=statistics&id=' . $channelId . '&key=' . $APIKey,
                                            ...
                                            $youtube_followers_count = $response['items'][0]['statistics']['subscriberCount'];
                                        }
                                        // Youtube API
                                        ...
                                        <span class="badge rounded-pill badge-light-info link-bottom">Twitter - {{ $twitter_followers_count }}</span>
                                        @endif
                                        @if($youtube_followers_count != NULL)
                                        <span class="badge rounded-pill badge-light-info link-bottom">Youtube - {{ $youtube_followers_count }}</span>
                                        @endif
                                        ...
                                        <td class="text-center">
                                            ...
                                            <input type="checkbox" class="form-check-input"
                                                onchange="window.location.href='{{ url('change-fav-status/'.$influencer->id) }}'"
                                                checked>
