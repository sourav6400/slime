                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header border-bottom d-flex justify-content-between">
                            ...
                            <a href="{{ route('create_new_package') }}" class="btn btn-primary" style="float: right;">Create New Package</a>
                        </div>
                        <!--Search Form -->
                        <div class="">
                            <table id="inf_table" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="{{ url('package-detail/'.$package->id) }}">{{ $package->package_name }}</a></td>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body p-3 pt-0">
                ...
                <form id="deletePermissionModal" class="row" onsubmit="return true" novalidate="novalidate" action="{{ route('remove_package') }}" method="POST">
                    @csrf
