                                ...
                                <div class="card">
                                    ...
                                    <table id="myTable" class="scrolldown table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            $ifluencer_template_content_qry = DB::table('ifluencer_template_content')
                                                ->where('influencer_id', $influencer_detail->id)
                                                ->where('template_id', $influencer_template_detail->id)->first();
                                            if($ifluencer_template_content_qry)
                                            {
